...
MDM.Utils = {
  ...
  controlsTemplate: function(){
    ...
    var template =
      ...
      "  <ul>" +
      "    <li class=\"mdm-bold\"><a tabindex=\"-1\" title=\"bold\" class=\"fi-bold bigger\" href=\"#mdm-bold\"><span>B</span></a></li>" +
      "    <li class=\"mdm-italic\"><a tabindex=\"-1\" title=\"italic\" class=\"fi-italic\" href=\"#mdm-italic\"><span>I</span></a></li>" +
      "    <li class=\"mdm-strike\"><a tabindex=\"-1\" title=\"strikethrough\" class=\"fi-strike\" href=\"#mdm-strike\"><span>S</span></a></li>" +
      "    <li class=\"mdm-title\"><a tabindex=\"-1\" title=\"height\" class=\"fi-text-color\" href=\"#mdm-title\"><span>T</span></a></li>" +
      "    <li class=\"mdm-quote\"><a tabindex=\"-1\" title=\"blockquote\" class=\"fi-quote\" href=\"#mdm-quote\"><span>Q</span></a></li>" +
      ...
      "    <li class=\"mdm-list\"><a tabindex=\"-1\" title=\"list\" class=\"fi-list-bullet\" href=\"#mdm-list\"><span>l</span></a></li>" +
      "    <li class=\"mdm-link\"><a tabindex=\"-1\" title=\"link\" class=\"fi-link\" href=\"#mdm-link\"><span>a</span></a></li>" +
      "    <li class=\"mdm-img\"><a tabindex=\"-1\" title=\"img\" class=\"fi-photo\" href=\"#mdm-img\"><span>Img</span></a></li>" +
      "    <li class=\"mdm-gist\"><a tabindex=\"-1\" title=\"GitHub Gist\" class=\"fi-social-github\" href=\"#mdm-gist\"><span>G</span></a></li>" +
      "  </ul>" +
      "</div>";
